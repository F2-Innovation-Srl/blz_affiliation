...
class TemplateTable {
	...
	function __construct($option_name,$current) {
        ...
        $this->row =  [
            ...
            (new Fields\Text($option_name."_website_ga",$row["website_ga"],"text")),
            (new Fields\Text($option_name."_website_trk",$row["website_trk"],"text")),
    ...
    public function render(){
        ...
        <table>
            <tr valign="top" style="text-align:left">
                <th>Attivo</th>   <th>Valore TRK_ID Default</th>  <th>Valore GA Default</th>  <th>{website} TRK_ID </th>   <th>{website} GA </th>      
            </tr>
            <tr valign="top" style="text-align:left">
