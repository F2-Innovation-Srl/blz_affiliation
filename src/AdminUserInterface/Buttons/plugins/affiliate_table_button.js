(function() {
    ...
    var plugin_name = 'affiliate_table_button';
    ...
    tinymce.create('tinymce.plugins.' + plugin_name , {
        ...
        init : function(ed, url) {
                ...
                ed.addButton(plugin_name, {
                        title : 'Inserisci tabella affiliazione',
                        cmd : plugin_name + '_cmd',
                        icon: 'link',
                        image : url + '/assets/table.svg'
                });

                
                // Register the command so that it can be invoked by using 
                // tinyMCE.activeEditor.execCommand('affiliate_table');
                ed.addCommand(plugin_name + '_cmd', 
                        ...
                        function() {
                                ...
                                ed.windowManager.open({                                        
                                        file : ajaxurl + '?action=affiliate_table_button_action',
                                        //file   : url + '/dialog-AffiliateTableButton.html',
                                        width  : 650,
                                        height : 250,
                                        inline : 1
                                }, {
