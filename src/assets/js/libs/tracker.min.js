...
var Tracker = /*#__PURE__*/function () {
  function Tracker(args) {
    ...
    if (typeof gtag == 'undefined') {
      this.insertGTAG(this.gaid, function () {
        gtag('config', _this.gaid, {
          'send_page_view': false,
          'groups': 'blz_ga_tracker'
        });
      });
    } else {
  ...
  _createClass(Tracker, [{
    ...
    value: function trackEvt(name, args, GAID) {
      var gaid = typeof GAID != 'undefined' ? gaid = GAID : this.gaid; // console.log('_t| now tracking... ', name, args, gaid);

      if (gaid == null) return;
      if (typeof name == 'undefined' || name == null || name == '') return;
      var send_to = {
        'send_to': 'blz_ga_tracker'
      };
      if (typeof args != 'undefined') gtag('event', name, _objectSpread(_objectSpread({}, send_to), args));else gtag('event', name, send_to);
    }
    /**
