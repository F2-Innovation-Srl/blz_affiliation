(function() {
    ...
    const plugin_name = 'affiliation_button';
    const action_name = 'affiliation_button_action';
    ...
    tinymce.create('tinymce.plugins.' + plugin_name , {
        ...
        init : function(ed, url) {
                ...
                ed.addButton(plugin_name, {
                        ...
                        icon: 'link',
                        image : url + '/assets/affiliation-link.svg'
                });
                ...
                ed.addCommand(plugin_name + '_cmd', 
                        ...
                        function() {
                                ...
                                ed.windowManager.open({                                        
                                        file : `${ajaxurl}?action=${action_name}`,
                                        //file   : url + '/dialog-AffiliateButton.html',
                                        width  : 650,
                                        height : 400,
                                        inline : 1
                                }, {
